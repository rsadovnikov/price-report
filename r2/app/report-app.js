...
(function () {
  ...
  /* Сценарий (решение Романа 2026-08-22): у верхнего объявления в «Моих
     ...
     читает четыре экрана, а конкуренты в это время «находятся».
  ...
  /* Первый шаг — «Чем полезен этот сервис» (макет 2751:137754, 2026-09-18): три
     карточки пользы, дальше прежние три шага «как с ним работать». В макете четыре
     точки — шаг встал ПЕРЕД ними, а не вместо первого. Иллюстрации — экспорт узлов
     @3x: у «×2» шрифт Grtsk, которого в ДС нет, поэтому плитка картинкой; подложка
     под ней — два вектора макета одним svg. Стили карточек — в report-app.html. */
  var BENEFITS =
    ...
    +     '<img class="onb-benefit__art onb-benefit__art--radar" src="media/onb-benefit-radar.png?v=202609212010" width="73" height="73" alt="">'
    +   '</div>'
    +   '<div class="onb-benefit">'
    ...
    +     '<img class="onb-benefit__art" src="media/onb-benefit-price.png?v=202609212010" width="70" height="70" alt="">'
    +   '</div>'
    +   '<div class="onb-benefit onb-benefit--promo">'
    +     '<div class="onb-benefit__body">'
    +       '<p class="onb-benefit__text">Собственники снижают цену <b>в&nbsp;два раза чаще</b>, если им показывают отчёт о&nbsp;конкурентах</p>'
    ...
    +     '<img class="onb-benefit__art" src="media/onb-benefit-x2.png?v=202609212010" width="70" height="70" alt="">'
    +   '</div>'
    + '</div>';
  var STEPS = [
    { title: 'Чем полезен этот сервис',
      content: BENEFITS,
      button: 'Ок, как с ним работать' },
    { title: 'Обзор конкурентов объекта',
      ...
      video: 'media/onb-1.mp4?v=202609212010',
      poster: 'media/onb-1.jpg?v=202609212010' },
    { title: 'Изменения в онлайн-режиме',
      ...
      video: 'media/onb-2.mp4?v=202609212010',
      poster: 'media/onb-2.jpg?v=202609212010' },
    { title: 'Отчёт для собственника',
      ...
      video: 'media/onb-3.mp4?v=202609212010',
      poster: 'media/onb-3.jpg?v=202609212010' }
  ];
