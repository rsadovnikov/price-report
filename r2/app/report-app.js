...
(function () {
  ...
  var BENEFITS =
    ...
    +     '<img class="onb-benefit__art onb-benefit__art--radar" src="media/onb-benefit-radar.png?v=202609190033" width="73" height="73" alt="">'
    +   '</div>'
    +   '<div class="onb-benefit">'
    ...
    +     '<img class="onb-benefit__art" src="media/onb-benefit-price.png?v=202609190033" width="70" height="70" alt="">'
    +   '</div>'
    ...
    +     '<img class="onb-benefit__art" src="media/onb-benefit-x2.png?v=202609190033" width="70" height="70" alt="">'
    +   '</div>'
    + '</div>';
  var STEPS = [
    ...
    { title: 'Обзор конкурентов объекта',
      ...
      video: 'media/onb-1.mp4?v=202609190033',
      poster: 'media/onb-1.jpg?v=202609190033' },
    { title: 'Изменения в онлайн-режиме',
      ...
      video: 'media/onb-2.mp4?v=202609190033',
      poster: 'media/onb-2.jpg?v=202609190033' },
    { title: 'Отчёт для собственника',
      ...
      video: 'media/onb-3.mp4?v=202609190033',
      poster: 'media/onb-3.jpg?v=202609190033' }
  ];
