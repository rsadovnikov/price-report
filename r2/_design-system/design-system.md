...
components/             веб: кнопки, инпуты, чипы, шторка, выпадайка, слайдер, тосты…
...
template/               заготовка нового прототипа: копировать целиком, порядок — prototype-protocol.md
```
...
Как заводится новый прототип целиком — папка, данные, запуск, тесты, деплой —
[prototype-protocol.md](prototype-protocol.md); рабочая заготовка — `template/`.
